...
export default function ImageToPdf({ endpoint, quotaUrl }) {
    ...
    return (
        <div className="max-w-5xl mx-auto px-6 pt-14 pb-24">
            <div className="text-center mb-12 fade-up">
                <h1 className="text-white text-4xl font-bold mb-3">Image en PDF</h1>
                <p className="text-stone-400 text-lg max-w-xl mx-auto">
                    Convertissez vos images JPG, PNG, WEBP en document PDF.
                </p>
            </div>
            ...
            <div className="max-w-2xl mx-auto mb-8 fade-up fade-up-delay-1">
                <div className="bg-white/[0.04] backdrop-blur-xl rounded-2xl border border-white/[0.08] p-6">
                    <form onSubmit={handleSubmit}>
                        <div
                            className={`border-2 border-dashed rounded-xl p-6 text-center cursor-pointer transition mb-4 ${dragging ? 'border-violet-larry bg-violet-larry/10' : 'border-white/10 hover:border-white/20'}`}
                        ...
                        >
                            {preview ? (
                                ...
                                <>
                                    <i className="fa-regular fa-image text-3xl text-white/20 mb-3 block"></i>
                                    <p className="text-white/50 text-sm">Glissez votre image ici ou <span className="text-violet-larry">cliquez pour choisir</span></p>
                                    <p className="text-white/25 text-xs mt-2">JPG, PNG, WEBP, GIF, BMP, TIFF</p>
                                </>
                            )}
                        ...
                        {file && (
                            <p className="text-white/40 text-xs mb-4 flex items-center gap-1.5">
                                <i className="fa-solid fa-file-image text-pink-400"></i>
                                {file.name}
                                <button type="button" onClick={() => { setFile(null); setPreview(null); }} className="ml-auto text-white/20 hover:text-red-400 transition">
                ...
                <div className="max-w-4xl mx-auto fade-up">
                    <div className="bg-white/[0.04] backdrop-blur-xl rounded-2xl border border-white/[0.08] overflow-hidden">
                        <div className="h-[200px] flex flex-col items-center justify-center gap-4 text-white/20">
                            <i className="fa-regular fa-image text-5xl text-pink-400/30 animate-pulse"></i>
